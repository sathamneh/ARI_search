...
if __name__ == '__main__':
    ...
    csvfiles = get_all_csv_files("/home/ubuntu/mypython/nyt")
    #df = read_data("/home/ubuntu/mypython/NYT_00192140.CSV")
    #df = [read_data(file) for file in csvfiles]
    ddf = dd.read_csv(csvfiles[:50],  blocksize="32MB", dtype={'digital_pub_date': str, 'print_pub_date': str, 'url': str,  'headline': str, 'is_archive_url': str, 'byline': str,'text': str})
    print("files read")
    ...
    #df = client.persist(ddfsub.loc[:10]['lazyresults'])
        ...
        #print(zvhngrams)
        print ("memory used in Bytes by zvhngrams " + str(sys.getsizeof(zvhngrams)))
